...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        input(f"{Fore.MAGENTA}Please provide your feedback: {Style.RESET_ALL}")
        if not user_input:
            print(f"{Fore.RED}No feedback provided.{Style.RESET_ALL}")
        ...
        print(f"{Fore.CYAN} Thank you for your feedback! We appreciate your input. {Style.RESET_ALL}")
        continue
